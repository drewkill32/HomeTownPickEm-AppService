...
public class TieBreakerGame : GameDto, IMapFrom<Game>
{
    public Guid WeeklyGameId { get; set; }

    public void Mapping(Profile profile)
    {
        profile.CreateMap<Game, TieBreakerGame>()
            .ForMember(x => x.HomeTeam, exp => exp.MapFrom(y => y.Home))
            .ForMember(x => x.AwayTeam, exp => exp.MapFrom(y => y.Away));
    }
}
