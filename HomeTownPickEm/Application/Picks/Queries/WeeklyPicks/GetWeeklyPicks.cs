...
{
    public class GetWeeklyPicksQueryHandler : IRequestHandler<GetWeeklyPicksQuery, IEnumerable<WeeklyPicksDto>>
    {
        private readonly ApplicationDbContext _context;

        public GetWeeklyPicksQueryHandler(ApplicationDbContext context)
        {
            _context = context;
        }

        public async Task<IEnumerable<WeeklyPicksDto>> Handle(GetWeeklyPicksQuery request,
    ...
    public class GetWeeklyPicksQuery : IRequest<IEnumerable<WeeklyPicksDto>>
    {
