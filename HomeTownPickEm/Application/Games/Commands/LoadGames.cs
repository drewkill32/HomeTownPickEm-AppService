...
{
    public class LoadGamesHandler : IRequestHandler<LoadGamesCommand, IEnumerable<GameDto>>
    {
        private readonly ApplicationDbContext _context;
        private readonly ICfbdHttpClient _httpClient;
        private readonly GameTeamRepository _repository;

        public LoadGamesHandler(ICfbdHttpClient httpClient, ApplicationDbContext context,
        ...
        public async Task<IEnumerable<GameDto>> Handle(LoadGamesCommand request, CancellationToken cancellationToken)
        {
    ...
    public class LoadGamesCommand : GameRequest, IRequest<IEnumerable<GameDto>>
    {
    }
}