...
const defaultValues =
  process.env.NODE_ENV === "development"
    ? {
        ...
        confirmPassword: process.env.NEXT_PUBLIC_REGISTER_PASSWORD,
      }
    : ({} as Inputs);
...
export const SignUpForm = ({ message }: Props) => {
  ...
  return (
    <div className="m-auto mx-auto my-4 max-w-sm px-3 text-card-foreground">
      <form className="rounded-lg border bg-card" action={signUp}>
...
export function CheckmarkCirle(props: ComponentProps<"svg">) {
  return (
    <svg
...
export function CircleOutline(props: ComponentProps<"svg">) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
