  ...
  public: {
    Tables: {
      ...
      league_season_members: {
        ...
        Relationships: [
          {
            foreignKeyName: "league_season_member_member_id_fkey"
            columns: ["member_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "league_season_member_season_id_fkey"
            columns: ["season_id"]
            isOneToOne: false
      ...
      league_seasons: {
        ...
        Relationships: [
          {
            foreignKeyName: "league_season_league_id_fkey"
            columns: ["league_id"]
            isOneToOne: false
    ...
    Enums: {
      league_member_role: "member" | "owner" | "commissioner"
    }
    CompositeTypes: {
      [_ in never]: never
    }
