...
namespace HomeTownPickEm
{
    ...
    {
        public ApplicationDbContext CreateDbContext(string name)
        {
            return new(Mock.Of<IWebHostEnvironment>(), new DbContextOptionsBuilder<ApplicationDbContext>()
                .UseInMemoryDatabase(name)
                .Options);
        }

        public void SeedDatabase(string name)
        {
            using var context = new ApplicationDbContext(Mock.Of<IWebHostEnvironment>(),
